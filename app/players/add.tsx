...
export default function AddPlayer() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const playerId = await createPlayer(db, input);

      Alert.alert(
        "Player Added Successfully",
        `${fullName.trim()} has been added to RPCA.`,
        [
          {
            text: "View Player",
            onPress: () =>
              router.replace({
                pathname: "/players/details",
                params: { id: playerId.toString() },
              }),
          },
        ]
      );
      ...
      Alert.alert(
        "Unable to Save",
        "Something went wrong while adding the player. Please try again."
      );
    } finally {
      setSaving(false);
    }
    ...
    >
      ...
      >
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerCopy}>
            <Text style={styles.headerEyebrow}>RPCA ACADEMY</Text>
      ...
      >
        <View style={styles.introCard}>
          ...
          <View style={styles.introCopy}>
            ...
            <Text style={styles.introText}>
              Add personal, cricket and parent information to create the
              player's academy record.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.formCard}>
          <View style={styles.parentHighlight}>
            ...
            <Text style={styles.parentHighlightText}>
              Parent contact information helps RPCA communicate academy
        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.joiningNote}>
            ...
            <Text style={styles.joiningNoteText}>
              Player will be registered with this academy joining date.
            </Text>
          </View>
        </View>
          ...
          >
            <DateTimePicker
              ...
              onChange={(_, date) => {
                ...
                if (date) handleJoiningDateChange(date);
              }}
            />
          </PickerCard>
        )}
          ...
          >
            ...
            <View style={styles.saveCopy}>
              <Text style={styles.saveButtonText}>
                {saving ? "Saving Player..." : "Save Player"}
              </Text>
              <Text style={styles.saveSubText}>
                {saving
                  ? "Creating RPCA profile"
                  : "Add player to academy records"}
              </Text>
            </View>
        ...
        <Text style={styles.secureText}>
          <Ionicons name="lock-closed-outline" size={10} /> Player information
          is stored securely in RPCA academy records.
        </Text>
